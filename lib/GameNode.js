...
class GameNode extends skynode_1.SkyNode {
    ...
    set y(y) { this.pixiContainer.y = y; }
    get y() { return this.pixiContainer.y; }
    set scaleX(scaleX) { this.pixiContainer.scale.x = scaleX; }
    get scaleX() { return this.pixiContainer.scale.x; }
    set scaleY(scaleY) { this.pixiContainer.scale.y = scaleY; }
